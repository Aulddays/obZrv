...
public:
	...
	static BasicBitmap *GdiPlusLoadImage(const wchar_t *filename, PixelFmt fmt = UNKNOW);
	static BasicBitmap *GdiPlusLoadImage(const void *content, long size, PixelFmt fmt = UNKNOW);
...
protected:
	...
	static void *LoadContent(const wchar_t *filename, long *size);
	static void *LoadContent(FILE *fp, long *size);
